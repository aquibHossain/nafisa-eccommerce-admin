...
// Charg Dashboard MUI examples components
import DefaultNavbarDropdown from "examples/Navbars/DefaultNavbar/DefaultNavbarDropdown";
import DefaultNavbarMobile from "examples/Navbars/DefaultNavbar/DefaultNavbarMobile";

// Charg Dashboard MUI Base Styles
          ...
          <Grid item xs={image ? 6 : 12}>
            {collapse.map((item, key) => {
              ...
              return (
                ...
                >
                  {item.description ? (
                    <Box display="flex" py={0.25} fontSize="0.875rem" color="text">
                      {typeof item.icon === "string" ? (
                        <Icon color="inherit" sx={{ mr: 1.25, mt: 0.125 }}>
                          {item.icon}
                        </Icon>
                      ) : (
                        <Box color="inherit" mr={1.25} mt={0.125}>
                          {item.icon}
                        </Box>
                      )}
