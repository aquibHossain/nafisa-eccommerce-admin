...
function StoreList() {
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        const response = await axios.get(`${config?.production_url}/store/admin/all`, {
          headers: {
  ...
  const handleAction = async (id) => {
    ...
    try {
      await axios.delete(`${config?.production_url}/store/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
              ...
              <TableBody>
                {list.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Link to={`/ecommerce/store/edit-store/${row?._id}`}>
                        <RemoveRedEyeIcon />
                      </Link>
                    </TableCell>
                    <TableCell align="center">
