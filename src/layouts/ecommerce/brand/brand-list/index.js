...
function BrandList() {
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        const response = await axios.get(`${config?.production_url}/brand/admin/all`, {
          headers: {
  ...
  const handleAction = async (id) => {
    ...
    try {
      await axios.delete(`${config?.production_url}/brand/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      toast.success("Brand Was Deleted Successfully");
    } catch (err) {
      console.error(err);
              ...
              <TableBody>
                {list.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Link to={`/ecommerce/brand/edit-brand/${row?._id}`}>
                        <RemoveRedEyeIcon />
                      </Link>
                    </TableCell>
                    <TableCell align="center">
