...
function EditBanner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`${config.production_url}/banner/${id}`, data, {
        headers: {
  ...
  useEffect(() => {
    const fetchBanner = async () => {
      try {
        const response = await axios.get(`${config?.production_url}/banner/${id}`, {
          headers: {
